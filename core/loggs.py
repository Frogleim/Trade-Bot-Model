...
actions_handler.setFormatter(logging.Formatter(f'{version} - %(asctime)s - %(levelname)s - %(message)s'))
...
finish_trade_handler.setFormatter(logging.Formatter(f'{version} - %(asctime)s - %(levelname)s - %(message)s'))
